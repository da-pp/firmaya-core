...
public class ControllerProcesoFirma {

    private final ServiceConsultaProcesoFirma serviceConsultaProcesoFirma;
    private final ServiceSolicitudesFirma serviceSolicitudesFirma;

    public ControllerProcesoFirma(ServiceConsultaProcesoFirma serviceConsultaProcesoFirma,
                                    ServiceSolicitudesFirma serviceSolicitudesFirma) {
        this.serviceConsultaProcesoFirma = serviceConsultaProcesoFirma;
        this.serviceSolicitudesFirma = serviceSolicitudesFirma;
    }
    ...
    public DetalleProcesoFirmaDto obtener(@PathVariable UUID idContrato,
        ...
        return serviceConsultaProcesoFirma.obtenerActualOUltimo(idContrato, usuario.idUsuario())
    ...
    public EnvioSolicitudesFirmaDto enviarSolicitudes(@PathVariable UUID idContrato,
        ...
        return serviceSolicitudesFirma.enviarSolicitudesIniciales(idContrato, usuario.idUsuario(), solicitud);
    }
    ...
    public ResultadoEntregaLoteDto reintentarFallidas(@PathVariable UUID idContrato,
        ...
        return serviceSolicitudesFirma.reintentarNotificacionesFallidas(idContrato, usuario.idUsuario(), cuerpo);
    }
    ...
    public SolicitudFirmaDto reenviar(@PathVariable UUID idContrato, @PathVariable UUID idSolicitud,
                                       @AuthenticationPrincipal ContextoUsuarioAutenticado usuario) {
        return serviceSolicitudesFirma.reenviar(idContrato, usuario.idUsuario(), idSolicitud);
    }
    ...
    public SolicitudFirmaDto renovar(@PathVariable UUID idContrato, @PathVariable UUID idSolicitud,
        ...
        return serviceSolicitudesFirma.renovar(idContrato, usuario.idUsuario(), idSolicitud, solicitud);
    }
}
