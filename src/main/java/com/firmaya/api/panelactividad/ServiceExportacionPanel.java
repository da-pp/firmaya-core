...
public class ServiceExportacionPanel {
    ...
    public ServiceExportacionPanel(ServicePanelActividad servicePanelActividad) {
        this.servicePanelActividad = servicePanelActividad;
    }

    public byte[] exportarContratos(ConsultaContratosPanel consulta) {
        List<Contrato> contratos = servicePanelActividad.listarTodosPorMetrica(consulta);
