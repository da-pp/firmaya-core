...
public class ControllerAutenticacion {
    ...
    public ControllerAutenticacion(ServiceAutenticacion serviceAutenticacion) {
    ...
    public ResponseEntity<RespuestaInicioSesion> iniciarSesion(@Valid @RequestBody SolicitudInicioSesion solicitud,
        ...
        ResultadoInicioSesion resultado = serviceAutenticacion.iniciarSesion(
    ...
    public ResumenUsuarioDto obtenerUsuarioActual(@AuthenticationPrincipal ContextoUsuarioAutenticado usuario) {
        return serviceAutenticacion.obtenerUsuarioActual(usuario.idUsuario());
    }

    @PostMapping("/cerrar-sesion")
    public ResponseEntity<Void> cerrarSesion(HttpServletRequest request) {
        obtenerCredencial(request).ifPresent(serviceAutenticacion::cerrarSesionActual);
