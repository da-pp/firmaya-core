...
/**
 * Servicio interno transversal de envio de correo (no expuesto como endpoint), usado por
...
public class ServicioEnvioNotificaciones {
    ...
    private static final Logger log = LoggerFactory.getLogger(ServicioEnvioNotificaciones.class);
    ...
    public ServicioEnvioNotificaciones(JavaMailSender javaMailSender,
                                        RepositorioTipoEventoNotificacion repositorioTipoEventoNotificacion,
    ...
    public boolean enviarCorreoOperativo(Usuario destinatario, String codigoTipoEvento, String titulo,
        ...
        TipoEventoNotificacion tipoEvento = repositorioTipoEventoNotificacion.findByCodigoAndActivoTrue(codigoTipoEvento)
