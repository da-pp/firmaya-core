...
@RestController
public class ControladorCatalogoPlantillas {

    private final ServicioCatalogoPlantillas servicioCatalogoPlantillas;

    public ControladorCatalogoPlantillas(ServicioCatalogoPlantillas servicioCatalogoPlantillas) {
    ...
    public List<CatalogoPlantillaDto> buscarPlantillasActivas(@RequestParam(required = false) TipoContrato tipo) {
        return servicioCatalogoPlantillas.buscarPlantillasActivas(tipo);
    }
    ...
    public FormularioPlantillaDto obtenerFormulario(@PathVariable UUID idPlantilla, @PathVariable UUID idVersion) {
        return servicioCatalogoPlantillas.obtenerFormulario(idPlantilla, idVersion);
    }
}
