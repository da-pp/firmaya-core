 ...
 * el mismo criterio de acceso minimo de ServiceAutorizacionContrato (cualquier participacion
...
public class ServiceConsultaVersionesContrato {
    ...
    public ServiceConsultaVersionesContrato(RepositoryContrato repositoryContrato,
    ...
    private PaginaDto<ResumenVersionContratoDto> listarHistorial(Contrato contrato, Integer pagina) {
        ...
        var resultado = repositoryVersionContrato.findByContratoIdOrderByNumeroVersionDesc(contrato.getId(), paginado);
