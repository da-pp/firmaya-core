 ...
 */
@Component
public class ServicioAutorizacionContrato {

    private final RepositorioParticipante repositorioParticipante;

    public ServicioAutorizacionContrato(RepositorioParticipante repositorioParticipante) {
    ...
    public Optional<RolParticipacion> rolParticipacionInterna(UUID idContrato, UUID idUsuario) {
        return repositorioParticipante.findByContratoId(idContrato).stream()
